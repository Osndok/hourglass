 ...
 */
public class HourglassException extends Exception implements IHourglassException {
	
	private HourglassExceptionBase m_base;
	
	public HourglassException() {
		// do nothing
	}
	
	public HourglassException(String key, String[] args) {
		this(null, null, key, args);
	}

	public HourglassException(String message, Throwable cause, String key, String[] args) {
		super(message, cause);
		m_base = new HourglassExceptionBase(key, args);
	}

	public HourglassException(Throwable cause, String key, String[] args) {
